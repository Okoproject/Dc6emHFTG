...
10:
    ...
    Private Sub Form2_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        If RadioButton4.Checked = True Then
            My.Settings.shiori_PS = False
        Else
            My.Settings.shiori_PS = True
        End If

        If CheckBox1.Checked = True Then
            My.Settings.autoBM = True
        Else
            My.Settings.autoBM = False
        End If

        My.Settings.autoBMDir = TextBox10.Text
        ...
        My.Settings.Fumei2 = TextBox11.Text
